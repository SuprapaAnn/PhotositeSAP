    ...
    <div class="container" style="margin-top: 100px;margin-bottom: 50px;">
      <div class="row justify-content-center">
        <div class="col-xl-4 col-md-6 col-sm-12"> 
          <p class="head text-center">Sign up</p>
          <div class="container">
            <form action="sign_up_db.php" method="POST" class="register-form" id="register-form">        
              ...
              <div class="form-group">
                  <label for="add"><i class="zmdi zmdi-pin-drop"></i></label>
              ...
              <div class="text-center mb-5">
                <button type="submit" name="btn_sub" class="btn btn-secondary rounded-pill px-4 my-2 " style="font-size: 20px;letter-spacing: 1px;">Register</button>
              </div>
            </form>           
          </div>
        </div>
        <div class="col-xl-4 col-md-6 col-sm-12">
          <img src="pic/girl-jumping-with-excitement-doorway-with-sea.jpg" class="position-relative top-50 start-50 translate-middle" alt="#" style="width: 100%;">
        </div>   
      </div>
    </div>
