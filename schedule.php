...
<head>
  ...
  <body style="font-family: fc_activeregular;letter-spacing: 3px;">
      ...
      <nav class="nevtop navbar navbar-expand-lg fixed-top navbar-light bg-yellow">
        ...
        <div class="collapse navbar-collapse justify-content-end me-5" id="navbarCollapse">
          <ul class="navbar-nav ">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="schedule.php"aria-current="page">Schedule</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link" id="AccountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" >
                Account
              </a>
    ...
    <div class="container-fluid" style="margin-top: 100px;">
      <div class="row">
        <div class="col">        
          <div class="container text-center px-0 pb-2">
            <img src="pic/ph1.png" width="120px" alt="Leon Brigg">
            <p style="font-size:20px;letter-spacing: 0px;">Leon Brigg</p>
          </div>
          <div class="container text-center px-0 pb-2">
            <img src="pic/ph2.png" width="120px" alt="Owen Wilkerson">
            <p style="font-size:20px;letter-spacing: 0px;">Owen Wilkerson</p>
          </div>
          <div class="container text-center px-0 pb-2">
            <img src="pic/ph3.png" width="120px" alt="Eileen Reeves">
            <p style="font-size:20px;letter-spacing: 0px;">Eileen Reeves</p>
          </div>
        </div>
        <div class="col">
          <p class="head">Schedule</p>
        </div>
      </div>   
    </div>
