    ...
    <div class="container" style="margin-top: 100px;margin-bottom: 50px;">
      <div class="row justify-content-center">
        <div class="col-xl-4 col-md-6 col-sm-12"> 
          <p class="head text-center">EDIT</p>
          <div class="container">
            <form action="edit_db.php" method="POST" class="register-form" id="register-form">
              ...
              <div class="form-group">
                ...
                <input type="text" name="phone" id="phone" placeholder="Phone Number" value=<?php echo $_SESSION['phone']?> maxlength="10" 
                  pattern="[0-9]{10}" title="some thing is wrong"
                  required />
              </div>
              <div class="form-group">
                  <label for="address"><i class="zmdi zmdi-pin-drop"></i></label>
                  <input type="text" name="address" id="address" placeholder="Address" value=<?php echo $_SESSION['address']?>>
              </div>
              <div class="form-group">
              ...
              <?php endif ?>
              <div class="text-center mb-5" style="font-size: 20px;letter-spacing: 1px;">
                <button type="submit" name="btn_up" class="btn btn-secondary rounded-pill px-4 my-2 mx-3" style="font-size: 20px;letter-spacing: 1px;">Done</button>
        ...
        <div class="col-xl-4 col-md-6 col-sm-12">
          <img src="pic/cute-attractive-stylish-smiling-woman-walking-city-street-pink-coat-spring-fashion-trend-holding-purse-elegant-style.jpg" class="position-relative top-50 start-50 translate-middle" alt="#" style="width: 100%;">
        </div>
      </div>
    </div>
